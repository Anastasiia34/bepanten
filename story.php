...
<section class="<?php echo $spoPrefix ?>-main">
        <?php include($_SERVER['DOCUMENT_ROOT']."/$spoPath/includes/sections/story.php") ?>
        <?php //include($_SERVER['DOCUMENT_ROOT']."/$spoPath/includes/sections/check-list.php") ?>
        <?php include($_SERVER['DOCUMENT_ROOT']."/$spoPath/includes/sections/more-stories.php") ?>
